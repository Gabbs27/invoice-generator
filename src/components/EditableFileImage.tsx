...
const EditableFileImage: FC<PropsWithChildren<Props>>= ({ className, placeholder, value, width, onChangeImage, onChangeWidth, pdfMode }) => {
        ...
        <>
          ...
          {isEditing && (
            <div ref={widthWrapper} className="image__width-wrapper">
              <Slider min={100} max={250} marks={marks} included={false} step={1}  defaultValue={width || 100} />
            </div>
          )}
        </>
      )}
