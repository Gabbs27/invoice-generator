...
describe('el archivo 606', () => {
  ...
  // Las 23 casillas en el orden de la NG 07-2018, Anexo A. Como GenerarArchivo en la herramienta 606
  // de la DGII: sin salto después de la última línea. Las líneas se separan con LF, como en los
  // archivos que la Oficina Virtual aceptó.
  it('escribe el encabezado y una línea por compra, separadas por LF y sin salto al final', () => {
  ...
  // La herramienta calcula el ITBIS por adelantar en cada fila y lo escribe aunque sea cero.
  it('deja vacíos los montos en cero, menos el ITBIS por adelantar', () => {
    ...
    expect(archivo606('123456789', '202609', [exenta])).toBe(
      '606|123456789|202609|1\n' +
        '987654321|1|02|B0100000123||20260905|||1000.00|1000.00|||||0.00||||||||01'
    );
  });
